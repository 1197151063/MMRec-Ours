...
def main():
    ...
    parser.add_argument('--suite', choices=['order', 'init', 'profile', 'corr', 'group', 'wbpr', 'relation'], default='order')
    ...
    if args.suite == 'relation':
        from relation_plan import build_plan as selected_plan
    elif args.suite == 'wbpr':
        from wbpr_plan import build_plan as selected_plan
    elif args.suite == 'group':
        from group_plan import build_plan as selected_plan
    elif args.suite == 'corr':
